...
class IdasUESTC():
    ...
    def _get_salt(self):
        ...
        self._get_static_file(mode='normal', jsessionid=JSESSIONID)
    ...
    def _relogin(self):
        ...
        self._get_static_file(mode='abnormal', jsessionid=self.cookies['JSESSIONID'])

    def _get_static_file(self, mode='normal', jsessionid=''):
        ...
        if mode == 'normal':
            ...
            cookies.pop('org.springframework.web.servlet.i18n.CookieLocaleResolver.LOCALE')
            for file in self.static_file:
                ...
                requests.get(f'{url}{file};{jsessionid}', headers=headers, cookies=cookies)
        else:
            for file in self.static_file:
                if file.endswith('.js'):
                    headers['Accept'] = '*/*'
    ...
    def _qrconnect(self):
        ...
        response = requests.get(url, params=params, cookies=self.cookies, headers=self.qrheaders)
...
if '__main__' == __name__:
    auth = IdasUESTC('2021090921019', '21323')
    auth.main()